 ...
 */
export var createStaticSource = function (options) {
    if (options === void 0) { options = {}; }
    var _a = options.initialRows, initialRows = _a === void 0 ? [] : _a, getRows = options.getRows;
    var init = function () { return __awaiter(void 0, void 0, void 0, function () {
        var rows;
        return __generator(this, function (_a) {
            rows = getRows ? getRows() : initialRows;
            return [2 /*return*/, {
